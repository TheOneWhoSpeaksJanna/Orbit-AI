...
1. Open Discord → Settings → Plugins (or Developer Settings → Plugins)
2. Tap "Add Plugin" / "Install from URL"
3. Paste:

   `https://raw.githubusercontent.com/TheOneWhoSpeaksJanna/Orbit-AI/main/plugins/hidden-channels/dist/index.js`

4. Enable the "Hidden Channels" toggle

## Install via custom bundle URL (advanced)

If ShiggyCord supports loading plugins from a GitHub Pages / raw source:
